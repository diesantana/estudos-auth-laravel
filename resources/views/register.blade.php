        ...
        <form action="/register" method="POST"
            ...
            <div class="flex flex-col w-full gap-3 text-slate-700">
                ...
                <input type="text" name="name" id="name" placeholder="Digite o seu nome"
                    @class([
                        'py-3 px-4 rounded-lg border-2 border-solid text-sm text-gray-400 focus:border-[#D1E9FF] focus:border-2 focus:border-solid focus:outline-none',
                        'border-red-400' => $errors->has('name'),
                        'border-[#D0D5DD]' => !$errors->has('name'),
                    ])>
                @error('name')
            ...
            <div class="flex flex-col w-full gap-3 text-slate-700">
                ...
                <div class="relative w-full">
                    ...
                    <input type="password" name="password" id="password" placeholder="Digite a sua senha"
                        @class([
                            'w-full rounded-lg border-2 border-[#D0D5DD] border-solid
            ...
            <div class="flex flex-col w-full gap-3 text-slate-700">
                ...
                <div class="relative w-full">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation"
                        placeholder="Digite a sua senha novamente" @class([
                            'w-full rounded-lg border-2 border-[#D0D5DD] border-solid
                            py-3 pl-4 text-sm text-gray-400 focus:border-[#D1E9FF]
                            focus:border-2 focus:border-solid focus:outline-none pr-10',
                            'border-red-400' => $errors->has('password_confirmation'),
                            'border-[#D0D5DD]' => !$errors->has('password_confirmation'),
                        ])>
                </div>
                {{-- Bloco de erros --}}
            ...
            {{-- BTN --}}
            <div class="w-full">
                <button type="submit" class="bg-blue-600 hover:bg-blue-500  w-full p-4 text-gray-50 cursor-pointer rounded-lg font-semibold shadow-lg">
                    Criar conta
                </button>
            </div>
            ...
            <div class="text-gray-400 flex justify-center">
                <p>
                    Já tem uma conta?
                    <a href="{{ route('login') }}" class="text-blue-600 hover:underline ml-2">Faça Login</a>
                </p>
            </div>
        </form>
        {{-- =================================================================== --}}
